<template>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 400 535" style="enable-background:new 0 0 400 535;" xml:space="preserve">
    <g id="C10017" @click="clickLocation('基隆市')" :class="{active: location === '基隆市'}">
      <desc>基隆市</desc>
      <path class="st2" data-name="keelung_city" d="M315.9,53.9c1.1-0.7,4.2-1.7,7.7-3.2c0.2,0.4,0.4,0.7,0.7,0.9c1.3,1,4,3.1,7.9,4.3c1.2,2.3,0.3,3.6,0.7,6.3
    ...
    <g id="C65" @click="clickLocation('新北市')" :class="{active: location === '新北市'}">
      <desc>新北市</desc>
      <path class="st1" data-name="new_taipei_city" d="M361.5,72.3c-6.8-0.3-9,0.3-9.3-6.2c1.2-11.2-6.2-9.3-13.7-9.3c-2.4,0-4.5-0.4-6.4-1c1.2,2.3,0.3,3.6,0.7,6.3
    ...
    c0.8,3.7,4.4,2.9,4.3,4.1c0,1.2,1.1,5.2,2.3,9.3C318.4,75.7,314.6,74.4,313,75.4z"></path>
    </g>
    <g id="C63" @click="clickLocation('臺北市')" :class="{active: location === '臺北市'}">
      <desc>臺北市</desc>
      <path class="st2" data-name="taipei_city" d="M317.1,71.5c1.2,4.1-2.5,2.9-4.1,3.9c-1.7,1,2.3,5.2,0,5.8c-7.7,0.4-8.1-3.1-11-5c-2.9-1.9-4.3-3.9-4.3-7
    c0-3-1.4-5.5-5.6-8.4c-4.1-2.9-2.9-5.2-0.8-5.6c2.1-0.4,15-8.2,16.4-8.7c1.4-0.5,2.7,1.9,1.9,3.7c-0.8,1.9,0.2,3.9,1,7.7
    c0.8,3.7,4.4,2.9,4.3,4.1C314.8,63.4,315.9,67.4,317.1,71.5z"></path>
    </g>
    <g id="C68" @click="clickLocation('桃園市')" :class="{active: location === '桃園市'}">
      <desc>桃園市</desc>
      <path class="st3" data-name="taoyuan_country" d="M287.8,135.2c-1.3,0.1-2.3-0.3-3.7-0.3c-1.9,0-4.1-3.3-5.4-5c-1.2-1.7-5.2-2.3-7.7-3.5c-2.5-1.2,0.4-5,1.7-8.1
    ...
    c-0.8,2.3-3.6,2.2-5.7,2.8L287.8,135.2"></path>
    </g>
    <g id="C10004" @click="clickLocation('新竹縣')" :class="{active: location === '新竹縣'}">
      <desc>新竹縣</desc>
      <path class="st2" data-name="hsinchu_country" d="M275.1,157.9c-0.2,0-5.3,1.1-7.4,1.4c0-2-2.5-5.5-3.4-8.1c-1-2.9-2.7-4.4-4.3-5c-1.7-0.6-3.5,1.5-4.6,2.2
    ...
    c0.6,2.1,0.2,3.6-3.1,5.4c-3.3,1.8-7.5,5.6-7.5,7.4c0,1.8,3.5,3.3,0,4.2L275.1,157.9z"></path>
    </g>
    <g id="C10018" @click="clickLocation('新竹市')" :class="{active: location === '新竹市'}">
      <desc>新竹市</desc>
      <path class="st1" data-name="hsinchu_city" d="M215.3,113.5c0.3-0.3,0.6-0.5,0.9-0.8c3.7-3.7,4-8.4,4-14c0-0.2,0-0.3,0-0.5c5.4,0.5,14.6,4.1,17.2,5.3
    c2.9,1.5,6.2,6.4,2.9,6.8c-3.3,0.4-5.6-0.6-7.7,2.3c-2.1,2.9-3.9,6-3.9,7c0,0.4-0.2,1.4-0.5,2.5c-2.4-2.1-4.8-4.4-5.7-5.6
    C221.1,114.9,218.8,114.4,215.3,113.5z"></path>
    </g>
    <g id="C10005" @click="clickLocation('苗栗縣')" :class="{active: location === '苗栗縣'}">
      <desc>苗栗縣</desc>
      <path class="st3" data-name="miaoli_country" d="M182.3,154.3c0.6-1.1,1.6-1.8,3.4-1.8c2.2-0.3,2.5-5.9,3.7-9.3c1.2-3.4,1.6-11.2,6.5-11.5c5-0.3,3.4-3.7,5-5.6
    ...
    c-2.7-1.7-2.9,0.6-8.3-3.9c-5.4-4.6-11.8-8.9-13-11.8C186.2,158.1,184,155.8,182.3,154.3z"></path>
    </g>
    <g id="C66" @click="clickLocation('臺中市')" :class="{active: location === '臺中市'}">
      <desc>臺中市</desc>
      <path class="st1" data-name="taichung_city" d="M168.4,194.1c-2.1-0.6-3-1-3.9-1.4c3-4.8,6.1-10.3,6.3-12.2c0.3-3.4,5.3-15.2,8.4-18.6c2-2.2,1.9-5.5,3.1-7.5
    ...
    c-2.3-0.8-9.5-2.7-9.7-6.6C171.9,197.2,172.1,195.2,168.4,194.1z"></path>
    </g>
    <g id="C10008" @click="clickLocation('南投縣')" :class="{active: location === '南投縣'}">
      <desc>南投縣</desc>
      <path class="st3" data-name="nantou_country" d="M280.2,188.3c0.1,3.1-0.3,5.2-2.2,5.6c-2.7,0.6-5.8-0.4-5.8,3.5c0,3.9,2.3,6.4,4.2,7.7c2,1.2,1.7,4.6-0.2,6
    ...
    c3.2-1.5,5.7,0.7,8.7-0.8c3-1.5,5.7,0.2,8.7,0.4C278.4,188.3,279.4,188.7,280.2,188.3z"></path>
    </g>
    <g id="C10007" @click="clickLocation('彰化縣')" :class="{active: location === '彰化縣'}">
      <desc>彰化縣</desc>
      <path class="st2" data-name="changhua_country" d="M131.9,248c0.3-0.3,0.7-0.7,1-1c6.5-6.5,11.5-19.3,11.5-23.9c0-4.7,11.2-10.3,11.2-13c0-2.8,0.9-7.1,3.4-9.6
    ...
    C135.9,248.7,133.8,248.3,131.9,248z"></path>
    </g>
    <g id="C10009" @click="clickLocation('雲林縣')" :class="{active: location === '雲林縣'}">
      <desc>雲林縣</desc>
      <path class="st1" data-name="yunlin_country" d="M131.9,293.8c5.4,0.4,2.5-6.4,3.9-5c1.5,1.5,4.6-0.2,5.2-2.1c0.6-1.9,0.6-2.7,2.9-2.5c2.3,0.2,2.3-0.6,2.3-2.5
    ...
    C125.3,290,126.6,293.3,131.9,293.8z"></path>
    </g>
    <g id="C10010" @click="clickLocation('嘉義縣')" :class="{active: location === '嘉義縣'}">
      <desc>嘉義縣</desc>
      <path class="st2" data-name="chiayi_country" d="M129.3,323.2c2.3-0.4,7.2-6.8,8.1-7.4c0.8-0.5,5.2-5.5,8.5-7.8c3.3-2.3,7.7-1.2,11-2.1c3.3-0.8,5.4,1,9.3,1.5
    ...
    c-1.4,1-2.7,0.6-4.8,1.7c-2.1,1-5.4,4.4-5.9,2.8c-0.5-1.6-1.6-4-3-4.3c-1.4-0.2-5.6,0.2-5.6-4.3C151.8,293.1,155,291.7,158.8,291.3z"></path>
    </g>
    <g id="C10020" @click="clickLocation('嘉義市')" :class="{active: location === '嘉義市'}">
      <desc>嘉義市</desc>
      <path class="st1" data-name="chiayi_city" d="M151.8,294.8c0-1.7,3.2-3.1,7-3.5c3.8-0.4,4.6,0.4,7.1,1.8c2.5,1.3,6.6,4.9,5.2,5.9c-1.4,1-2.7,0.6-4.8,1.7
    c-2.1,1-5.4,4.4-5.9,2.8c-0.5-1.6-1.6-4-3-4.3C156,298.9,151.8,299.4,151.8,294.8z"></path>
    </g>
    <g id="C67" @click="clickLocation('臺南市')" :class="{active: location === '臺南市'}">
      <desc>臺南市</desc>
      <path class="st3" data-name="tainan_city" d="M122.6,372c0.1-0.9,0.2-1.5,0.4-2c0.9-2.5,3.4-6.8,1.9-8.1c-1.6-1.2-5,1.2-5.6,3.7c-0.6,2.5-2.8-2.5-2.2-5.3
    ...
    c-1.9-0.2-6.4-1.9-7.9-2.9C127.1,376,124.5,374.1,122.6,372z"></path>
    </g>
    <g id="C64" @click="clickLocation('高雄市')" :class="{active: location === '高雄市'}">
      <desc>高雄市</desc>
      <path class="st1" data-name="kaohsiung_city" d="M157.9,441.7c-0.1-0.1-0.1-0.2-0.2-0.2c-8.1-0.9-14.6-8.7-17.7-13.7c-3.1-5-9-9.6-7.5-11.5
    ...
    C161.6,431.5,160.1,437.9,157.9,441.7z"></path>
    </g>
    <g id="C10013" @click="clickLocation('屏東縣')" :class="{active: location === '屏東縣'}">
      <desc>屏東縣</desc>
      <path class="st2" data-name="pingtung_country" d="M214.8,473.1c0.9,0.5,3.4,2.8,5.6,4.6c0.8,6.5,1.7,12.7,1.9,15.6c0.6,6.5,0.1,14.3-3.4,15.2
    ...
    C153.7,444.3,144.1,449.5,141.3,456z"></path>
    </g>
    <g id="C10014" @click="clickLocation('臺東縣')" :class="{active: location === '臺東縣'}">
      <desc>臺東縣</desc>
      <path class="st3" data-name="taitung_country" d="M296.6,302.5c0.9,0,1.8,0.1,2.6,0.2c-0.1,1-0.1,1.9-0.1,2.7c0,6.5-2.5,15.2-6.2,16.8
    ...
    c2-2.2,1.4-9-1.4-9.3c-2.8-0.3-8.7-2.2-5.9-3.4c2.8-1.2,2.5-9.9,0-11.3c-2.5-1.3-15-0.7-19,0C281.6,478.6,289.5,483.7,288.5,487.1z"></path>
    </g>
    <g id="C10015" @click="clickLocation('花蓮縣')" :class="{active: location === '花蓮縣'}">
      <desc>花蓮縣</desc>
      <path class="st2" data-name="hualien_country" d="M335.2,173.5c0.5,1.3,1.1,2.2-0.1,3.6c-2.2,2.5-16.5,18-15.2,25.8c-0.3,3.4-11.2,4.7-2.5,13.5
    ...
    c-0.6-1.5,7,1.4,8.4,3.3C325.3,172,328.8,174.7,335.2,173.5z"></path>
    </g>
    <g id="C10002" @click="clickLocation('宜蘭縣')" :class="{active: location === '宜蘭縣'}">
      <desc>宜蘭縣</desc>
      <path class="st3" data-name="yilan_country" d="M356.3,77.1c1.5,0.2,3.3,0.5,5.1,0.8c-1.1,0.8-2.2,1.6-3.2,2.1c-3.7,2-9.6,5.1-10.3,10.3
    ...
    C352.7,80.4,352.5,76.7,356.3,77.1z"></path>
    </g>
    <g id="C10016" @click="clickLocation('澎湖縣')" :class="{active: location === '澎湖縣'}">
      <desc>澎湖縣</desc>
      <path class="st3" data-name="penghu_country" d="M30.7,283.9c-2.2-3.7,4.7-11.2,5.3-6.5c0.6,4.7,1.6,5.2,7.8,0.9c6.2-4.4,10.9,8.7,7.8,8.1
    ...
    c0.9,2.5,9,6.9,10.6,5.3c1.6-1.6,4-6.2,0-9.8C36.6,262.5,27.6,264,30,270.6z"></path>
    </g>
    <g id="C09020" @click="clickLocation('金門縣')" :class="{active: location === '金門縣'}">
      <desc>金門縣</desc>
      <path class="st4" data-name="kinmen_country" d="M9.5,176.7c2.8-0.6,6.5,3.4,3.4,6.8c-3.1,3.4-6.6,5.3-7.8,0C4.1,178.3,6.4,177.4,9.5,176.7z M20.7,176.7
    ...
    C24.4,172.4,20.7,171.3,20.7,176.7z"></path>
    </g>
    <g id="C09007" @click="clickLocation('連江縣')" :class="{active: location === '連江縣'}">
      <desc>連江縣</desc>
      <path class="st1" data-name="lienchiang_country" d="M26.5,105.6c0,0,0.3,5.3,4.1,3.2c0,0,1.8-5,6.2-5.1c0,0,4.4-0.8,4.7,1.9c0,0,0.8,5-1.8,6.8c0,0-6-0.3-5.6,2.9
    ...
    C50.1,66.8,41.6,74,41.6,74c-2.3,2.3,0,4.7,0,4.7C44.6,80.2,40.6,85.9,40.6,85.9z"></path>
    </g>
  </svg>
</template>
